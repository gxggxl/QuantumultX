...
const header = {
    ...
    'Referer': `http://m.zhcw.com/kaijiang/index.jsp?lottery=FC_SSQ`,
...
function ringInfo(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url: "http://m.zhcw.com/clienth5.do?transactionType=8010&busiCode=300109&cache=yes&src=0000100001%7C6000003060",
            headers: header,
            body: ``,
        }
        $.post(url, async (err, resp, data) => {
